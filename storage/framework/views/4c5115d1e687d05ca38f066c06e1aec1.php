...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between bg-gradient-to-r from-[#003829] to-[#00593E] p-6 rounded-2xl shadow-md text-white border border-emerald-900">
        ...
        <div class="mt-4 md:mt-0 flex items-center space-x-3">
            <?php if($latestDraft): ?>
                <a href="<?php echo e(route('ojt.logbooks.edit', $latestDraft->id)); ?>" class="inline-flex items-center px-4 py-2.5 bg-[#F5A623] hover:bg-amber-500 text-gray-900 font-bold text-xs rounded-xl shadow-sm transition-all transform hover:-translate-y-0.5">
        ...
        <div class="mb-8 bg-amber-50 border-l-4 border-[#F5A623] p-5 rounded-2xl shadow-xs">
            <div class="flex items-start justify-between">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h3 class="text-xs font-extrabold text-amber-900 uppercase tracking-wider">Pemberitahuan Revisi Logbook (<?php echo e($kpi['revision']); ?> Logbook Perlu Tindakan)</h3>
                ...
                <a href="<?php echo e(route('ojt.logbooks.index', ['status' => 'revision'])); ?>" class="px-3.5 py-2 bg-amber-500 hover:bg-amber-600 text-gray-900 text-xs font-bold rounded-xl shadow-xs transition flex-shrink-0">
                    Buka Logbook Revisi
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 mb-8">
        ...
        <!-- Draft KPI -->
        <a href="<?php echo e(route('ojt.logbooks.index', ['status' => 'draft'])); ?>" class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:border-slate-400 transition group">
            ...
            <div class="mt-3 flex items-baseline justify-between">
                <span class="text-3xl font-extrabold text-slate-800"><?php echo e($kpi['draft']); ?></span>
                <span class="text-[11px] font-medium text-slate-400">Belum Dikirim</span>
            </div>
        </a>

        <!-- Submitted KPI -->
        <a href="<?php echo e(route('ojt.logbooks.index', ['status' => 'submitted'])); ?>" class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:border-blue-300 transition group">
            <div class="flex items-center justify-between">
            ...
            <div class="mt-3 flex items-baseline justify-between">
                <span class="text-3xl font-extrabold text-blue-700"><?php echo e($kpi['submitted']); ?></span>
                <span class="text-[11px] font-medium text-blue-500">Menunggu Review</span>
            </div>
        </a>

        <!-- Revision KPI -->
        <a href="<?php echo e(route('ojt.logbooks.index', ['status' => 'revision'])); ?>" class="bg-white p-5 rounded-2xl shadow-sm border <?php echo e($kpi['revision'] > 0 ? 'border-amber-300 ring-2 ring-amber-100' : 'border-slate-200'); ?> hover:border-amber-400 transition group">
            <div class="flex items-center justify-between">
            ...
            <div class="mt-3 flex items-baseline justify-between">
                <span class="text-3xl font-extrabold text-amber-700"><?php echo e($kpi['revision']); ?></span>
                <span class="text-[11px] font-bold text-amber-600">Catatan Trainer</span>
            </div>
        </a>

        <!-- Approved KPI -->
        <a href="<?php echo e(route('ojt.logbooks.index', ['status' => 'approved'])); ?>" class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:border-emerald-300 transition group">
            <div class="flex items-center justify-between">
            ...
            <div class="mt-3 flex items-baseline justify-between">
                <span class="text-3xl font-extrabold text-[#003829]"><?php echo e($kpi['approved']); ?></span>
        ...
        <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
            ...
            <div class="mt-3">
                <div class="flex items-baseline justify-between">
                    <span class="text-2xl font-extrabold text-slate-800"><?php echo e(number_format($kpi['total_hm'], 1)); ?> <span class="text-xs text-slate-500 font-normal">HM</span></span>
                    <span class="text-xs font-bold text-[#00A859]"><?php echo e($kpi['progress_percentage']); ?>%</span>
                </div>
                <div class="w-full bg-slate-100 rounded-full h-2 mt-2 overflow-hidden">
                    <div class="bg-[#00A859] h-2 rounded-full transition-all duration-500" style="width: <?php echo e($kpi['progress_percentage']); ?>%"></div>
                </div>
                <span class="text-[10px] text-slate-400 mt-1 block">Target OJT: <?php echo e($kpi['target_hm']); ?> HM</span>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 flex flex-col gap-8">
            ...
            <div class="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <a href="<?php echo e(route('ojt.logbooks.index')); ?>" class="h-full p-7 bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:border-blue-400 transition group flex flex-col justify-between">
                    <div class="flex items-center justify-between">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                <div class="flex items-center justify-between mb-5">
                    ...
                    <a href="<?php echo e(route('ojt.history')); ?>" class="text-xs font-bold text-[#00A859] hover:underline">Lihat Semua</a>
                </div>
...
<?php endif; ?>
                            ...
                            <a href="<?php echo e(route('ojt.logbooks.show', $log->id)); ?>" class="mt-2 block text-sm font-bold text-slate-800 hover:text-[#00A859] break-words">
