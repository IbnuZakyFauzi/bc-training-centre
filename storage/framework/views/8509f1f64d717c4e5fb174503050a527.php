...
<head>
    <meta charset="UTF-8">
    <title>Logbook OJT - <?php echo e($logbook->logbook_number); ?></title>
    <style>
...
<body>
        ...
        <table>
            <tr>
                ...
                <td class="header-title">
                    ...
                    <p>No. Dokumen: <?php echo e($logbook->logbook_number); ?></p>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table class="grid">
        <tr>
            <th>Nama Trainee</th>
            <td><?php echo e($logbook->trainee->name ?? 'Ahmad Rian Syahputra'); ?></td>
            <th>NRP Trainee</th>
            <td><?php echo e($logbook->trainee->nrp ?? 'BC-60491'); ?></td>
        </tr>
        <tr>
            <th>Tanggal Operations</th>
            <td><?php echo e(\Carbon\Carbon::parse($logbook->date)->format('d F Y')); ?></td>
            <th>Shift Kerja</th>
            <td>Shift <?php echo e(ucfirst($logbook->shift)); ?></td>
        </tr>
        <tr>
            <th>Departemen</th>
            <td><?php echo e($logbook->department->name ?? 'Mining Operations'); ?></td>
            <th>Lokasi Pit / Area</th>
            <td><?php echo e($logbook->location); ?></td>
        </tr>
        <tr>
            <th>Unit Alat Berat</th>
            <td><?php echo e($logbook->equipment->unit_code ?? '-'); ?> (<?php echo e($logbook->equipment->model_name ?? '-'); ?>)</td>
            <th>Status Logbook</th>
            <td><strong><?php echo e(strtoupper($logbook->status)); ?></strong></td>
        </tr>
    </table>
    ...
    <table class="grid">
        <tr>
            ...
            <td style="width: 25%;"><?php echo e($logbook->start_time); ?> - <?php echo e($logbook->finish_time); ?></td>
            <th style="width: 25%;">HM Awal Unit</th>
            <td style="width: 25%;"><?php echo e(number_format($logbook->hm_start, 1)); ?></td>
        </tr>
        <tr>
            <th>HM Akhir Unit</th>
            <td><?php echo e(number_format($logbook->hm_end, 1)); ?></td>
            <th style="background-color: #e2e8f0;">TOTAL HM OPERASIONAL</th>
            <td style="background-color: #e2e8f0; font-weight: bold; font-size: 13px; color: #003829;"><?php echo e(number_format($logbook->total_hm, 1)); ?> Jam</td>
        </tr>
    </table>
    ...
    <table class="signature-table">
        <tr>
            <td>
                ...
                <p><b><u><?php echo e($logbook->trainee->name ?? 'Ahmad Rian Syahputra'); ?></u></b><br>NRP: <?php echo e($logbook->trainee->nrp ?? 'BC-60491'); ?></p>
            </td>
            <td>
                <p><b>Diverifikasi Oleh:</b><br>Trainer Evaluator</p>
                <div class="signature-space"></div>
                <p><b><u><?php echo e($logbook->trainer->name ?? 'Bambang Hermawan'); ?></u></b><br>Senior Instructor</p>
            </td>
            <td>
                <p><b>Disetujui Oleh:</b><br>Supervisor Lapangan</p>
                <div class="signature-space"></div>
                <p><b><u><?php echo e($logbook->supervisor->name ?? 'Rahmat Hidayat'); ?></u></b><br>Pit Superintendent</p>
            </td>
        </tr>
    </table>
